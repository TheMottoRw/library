...
$reqReservations = curlGetRequest("reservation.php?cate=bystudent&studentid=".$_SESSION['stdid']);
...
{               ?>
                                        <tr class="odd gradeX">
                                            ...
                                            <button class="btn btn-danger btn-sm" onclick="removeReservation(<?= "'".$result->id."'"; ?>,<?= "'".$_SESSION['stdid']."'"; ?>)"><i class="fa fa-trash-o "></i> Remove</button>
                                            </td>
                                        </tr>
 <?php $cnt=$cnt+1;} ?>
                                    </tbody>
