...
<head>
    ...
    <title>SLS | Issued Book Details</title>
...
<div class="form-group">
<label>Charges Per Day(RWF):</label>
<?php 
if($result->fine=="")
{?>
<input class="form-control" type="text" name="fine" id="fine"  required value="100" />
...
<button type="submit" name="return" id="submit" class="btn btn-info">Return Book </button> &nbsp&nbsp&nbsp&nbsp
