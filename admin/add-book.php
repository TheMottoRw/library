...
<!--AVAILABILITY OF ISBN CHECKING-->
<script>
function checkAvailability_isbn() {
$("#loaderIcon").show();
jQuery.ajax({
url: "check_availabilityISBN.php",
...
<input class="form-control" type="text" name="isbn" id="isbnid" onBlur="checkAvailability_isbn()"  autocomplete="off" required pattern="[1,2,3,4,5,7,6,8,9,0]*" />
 ...
 <input class="form-control" type="text" name="price" autocomplete="off"   required="required" pattern="[1,2,3,4,5,7,6,8,9,0]*" />
 </div>
<button type="submit" name="add" class="btn btn-info" id="submit">Add </button> &nbsp&nbsp&nbsp&nbsp
<button type="reset" name="Clear" class="btn btn-info"  >Clear </button>
