...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    <head>
        ...
        <title>SLS| Report of missing books</title>
    ...
    <div class="content-wrapper">
        <div class="container">
            <div class="row pad-botm">
                <div class="col-md-12">
                    <h4 class="header-line">Report of missing Books</h4>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                    <?php
                                    $results = json_decode(curlGetRequest("issuedbooks.php?cate=byfilter&status=2"));
                                            ...
                                            <tr class="odd gradeX">
                                             ...
                                             <?php echo "<button class='btn  btn-warning btn-xs'>" . htmlentities("Not Returned Yet") . "</button>"; ?>
                                                    ...
                                                    <?php } else if ($result->RetrunStatus == 2) {
                                                        ...
                                                        echo "<button class='btn  btn-warning btn-xs'>Missing</button>";
